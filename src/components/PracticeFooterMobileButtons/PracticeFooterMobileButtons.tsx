    ...
    return(
        <div className={styles.wrap}>
            ...
            <FooterButton
                ...
                name2={nextBtnName}
                color={isAnswerSelected&&typeOftest !== 'Result' ?color.FooterBackgroundNextBtnSelectedOption: color.FooterTextBtn }
                backgroundColor={color.FooterBackgroundBtn}
                svg={<ArrowPrevSmallSvg color={isAnswerSelected&&typeOftest !== 'Result' ?color.FooterBackgroundNextBtnSelectedOption: color.FooterTextBtn}  width="30px" height="30px" /> }
                rotate={'180deg'}
                fontSize={'20px'}
            />
        </div>
